package com.example.sonakshi.socialcops.ui.news;
...
import com.example.sonakshi.socialcops.data.NewsRepository;
import com.example.sonakshi.socialcops.databinding.FragmentOptionsBottomSheetBinding;
...
public class OptionsBottomSheet extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public static OptionsBottomSheet getInstance(String title, String url, int id, boolean isSaved, int i) {
        fragment = new OptionsBottomSheet();
        Bundle args = new Bundle();
        args.putString(PARAM_TITLE, title);
        args.putString(PARAM_URL, url);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            if(getArguments().containsKey("No_save")){
                noSave=0;
            } else {
                noSave=1;
            }
